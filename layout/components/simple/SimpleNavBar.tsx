...
const SimpleNavBar = () => {
    return (
        <nav className='sticky top-0 right-0 z-50 w-full h-full'>
            <div className='bg-primary absolute right-0 z-40 p-6 w-52 rounded-b-3xl text-center sm:flex gap-3 hidden'>
                <h1 className='font-bold w-full text-black text-lg'>Web Developer</h1>
            </div>
            <div className='bg-accent-2 absolute h-36 right-0 w-20 p-4 rounded-3xl sm:flex justify-center items-end hidden'>
