...
const WindowTab = () => {
    ...
    return (
        ...
        w-[90%] right-0 cursor-default overflow-hidden">
            ...
            <div className="bg-base-2  backdrop-blur-lg drop-shadow-lg border-t-0 2xl:h-[520px] h-96 rounded-b-lg flex justify-center items-center flex-col gap-20 relative">
                <div>
