...
const WindowTab = () => {
    return (
        <div className="sm:w-[60%] absolute top-1/3 sm:right-16 z-10
        w-[90%] right-0">
            <div className=" opacity-95 w-full h-10 rounded-t-lg  hover:opacity-100 bg-gray-800 flex justify-end items-center space-x-1.5 px-4">
